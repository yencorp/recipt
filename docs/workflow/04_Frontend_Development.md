...
**세부 작업**:
- [x] 재사용 가능한 폼 컴포넌트 (Input, Button, Select)
- [x] 모달 및 다이얼로그 컴포넌트
- [x] 테이블 및 페이지네이션 컴포넌트
- [x] 로딩 스피너 및 스켈레톤 UI
...
- `frontend/src/store/api/budgetsApi.ts`
- `frontend/src/schemas/budgetSchema.ts`
