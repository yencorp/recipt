...
export class CreateReceiptValidationsTable1757332305000
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        checks: [
          {
            ...
            expression:
              "original_extracted_amount IS NULL OR original_extracted_amount >= 0",
          },
          {
          ...
          },
          {
            ...
            expression:
              "validated_tax_amount IS NULL OR validated_tax_amount >= 0",
          },
          {
            name: "receipt_validations_confidence_range",
            expression:
              "original_confidence_score IS NULL OR (original_confidence_score >= 0 AND original_confidence_score <= 1)",
          },
          {
          ...
          },
          {
            ...
            expression:
              "accuracy_improvement IS NULL OR (accuracy_improvement >= -1 AND accuracy_improvement <= 1)",
          },
          {
            name: "receipt_validations_effort_score_range",
            expression:
              "validation_effort_score IS NULL OR (validation_effort_score >= 1 AND validation_effort_score <= 10)",
          },
          {
          ...
          },
          {
            ...
            expression:
              "training_value IS NULL OR (training_value >= 1 AND training_value <= 10)",
          },
          {
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_ocr_result_id",
        columnNames: ["ocr_result_id"],
      })
    );
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_assigned_to",
        columnNames: ["assigned_to"],
      })
    );
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_validated_by",
        columnNames: ["validated_by"],
      })
    );
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_status",
        columnNames: ["status"],
      })
    );
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_priority",
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_validation_type",
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_assigned_at",
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_completed_at",
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_sla_deadline",
        columnNames: ["sla_deadline"],
        where:
          "sla_deadline IS NOT NULL AND status NOT IN ('APPROVED', 'REJECTED')",
      })
    );
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_supervisor_review",
        columnNames: ["requires_supervisor_review"],
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_edge_case",
        columnNames: ["edge_case_indicator"],
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_validation_confidence",
        columnNames: ["validation_confidence"],
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_time_spent",
        columnNames: ["time_spent_seconds"],
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_assigned_status_priority",
        columnNames: ["assigned_to", "status", "priority"],
      })
    );
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_status_priority_assigned",
        columnNames: ["status", "priority", "assigned_at"],
      })
    );
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_type_status",
        columnNames: ["validation_type", "status"],
      })
    );
    ...
    await queryRunner.createIndex(
      "receipt_validations",
      new TableIndex({
        name: "idx_receipt_validations_correction_count",
        columnNames: ["correction_count"],
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // 트리거 삭제
    await queryRunner.query(
      `DROP TRIGGER IF EXISTS trigger_receipt_validations_metrics ON receipt_validations;`
    );
    await queryRunner.query(
      `DROP TRIGGER IF EXISTS trigger_receipt_validations_updated_at ON receipt_validations;`
    );
    await queryRunner.query(
      `DROP FUNCTION IF EXISTS update_validation_metrics();`
    );

    // 인덱스 삭제
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_receipt_validations_vendor_name_search;`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_receipt_validations_rejection_reason_search;`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_receipt_validations_notes_search;`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_receipt_validations_learning_tags_gin;`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_receipt_validations_risk_indicators_gin;`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_receipt_validations_quality_issues_gin;`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_receipt_validations_tags_gin;`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_receipt_validations_custom_attributes_gin;`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_receipt_validations_validated_items_gin;`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_receipt_validations_field_corrections_gin;`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_receipt_validations_changes_made_gin;`
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_correction_count"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_type_status"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_status_priority_assigned"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_assigned_status_priority"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_time_spent"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_validation_confidence"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_edge_case"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_supervisor_review"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_sla_deadline"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_completed_at"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_assigned_at"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_validation_type"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_priority"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_status"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_validated_by"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_assigned_to"
    );
    await queryRunner.dropIndex(
      "receipt_validations",
      "idx_receipt_validations_ocr_result_id"
    );
