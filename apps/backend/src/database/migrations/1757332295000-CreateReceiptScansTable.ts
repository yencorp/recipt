...
export class CreateReceiptScansTable1757332295000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
            ...
            new Table({
                ...
                checks: [
                    ...
                    },
                    {
                        ...
                        expression: "clarity_score IS NULL OR (clarity_score >= 0 AND clarity_score <= 1)",
                    },
                    {
                        name: "receipt_scans_brightness_score_range",
                        expression: "brightness_score IS NULL OR (brightness_score >= 0 AND brightness_score <= 1)",
                    },
                    {
                        name: "receipt_scans_contrast_score_range",
                        expression: "contrast_score IS NULL OR (contrast_score >= 0 AND contrast_score <= 1)",
                    },
                    {
                        name: "receipt_scans_readability_score_range",
                        expression: "text_readability_score IS NULL OR (text_readability_score >= 0 AND text_readability_score <= 1)",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        expression: "LENGTH(original_filename) >= 1 AND LENGTH(stored_filename) >= 1",
                    },
                    {
                        name: "receipt_scans_processing_duration_positive",
                        expression: "processing_duration_ms IS NULL OR processing_duration_ms >= 0",
                    },
                ],
                uniques: [
                    {
        ...
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_budget_expense_id", ["budget_expense_id"])
        );
        
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_uploaded_by", ["uploaded_by"])
        );
        
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_status", ["status"])
        );
        
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_file_format", ["file_format"])
        );
        
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_image_quality", ["image_quality"])
        );
        
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_file_hash", ["file_hash"], { isUnique: true })
        );
        
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_uploaded_at", ["uploaded_at"], {
        ...
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_processing_completed_at", ["processing_completed_at"], {
        ...
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_file_size", ["file_size"], {
        ...
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_text_readability", ["text_readability_score"], {
                order: { text_readability_score: "DESC" },
        ...
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_sensitive_data", ["contains_sensitive_data"], {
        ...
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_failed_processing", ["status", "retry_count"], {
                where: "status = 'FAILED'"
            })
        );
        ...
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_user_status_date", ["uploaded_by", "status", "uploaded_at"], {
                order: { uploaded_by: "ASC", status: "ASC", uploaded_at: "DESC" }
            })
        );
        
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_expense_status", ["budget_expense_id", "status"], {
                order: { budget_expense_id: "ASC", status: "ASC" }
            })
        );
        
        await queryRunner.createIndex(
            "receipt_scans",
            new Index("idx_receipt_scans_quality_format", ["image_quality", "file_format"], {
                order: { image_quality: "DESC", file_format: "ASC" }
            })
        );
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        // 트리거 삭제
        await queryRunner.query(`DROP TRIGGER IF EXISTS trigger_receipt_scans_processing_duration ON receipt_scans;`);
        await queryRunner.query(`DROP TRIGGER IF EXISTS trigger_receipt_scans_updated_at ON receipt_scans;`);
        await queryRunner.query(`DROP FUNCTION IF EXISTS update_receipt_scan_processing_duration();`);
        
        // 인덱스 삭제
        await queryRunner.query(`DROP INDEX IF EXISTS idx_receipt_scans_notes_search;`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_receipt_scans_filename_search;`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_receipt_scans_preprocessing_gin;`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_receipt_scans_tags_gin;`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_receipt_scans_crop_coordinates_gin;`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_receipt_scans_device_info_gin;`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_receipt_scans_exif_data_gin;`);
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_quality_format");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_expense_status");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_user_status_date");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_failed_processing");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_sensitive_data");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_text_readability");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_file_size");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_processing_completed_at");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_uploaded_at");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_file_hash");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_image_quality");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_file_format");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_status");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_uploaded_by");
        await queryRunner.dropIndex("receipt_scans", "idx_receipt_scans_budget_expense_id");
